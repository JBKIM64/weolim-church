      ...
      <div className="max-w-3xl mx-auto px-4 py-8 relative z-10">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 md:p-12 border border-amber-200">
          ...
          {devotional.today_hymn && (
            <MusicSection
              hymn1={Array.isArray(devotional.today_hymn) ? devotional.today_hymn[0] : devotional.today_hymn}
              hymn2={Array.isArray(devotional.today_hymn) && devotional.today_hymn[1] ? devotional.today_hymn[1] : (devotional.today_hymn_2 || undefined)}
            />
          )}
